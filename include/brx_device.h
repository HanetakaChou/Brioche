...
#include <stddef.h>
#include <stdint.h>
#include "brx_sampled_asset_image_format.h"
...
enum BRX_BACKEND_NAME
{
    BRX_BACKEND_NAME_D3D12 = 1,
    BRX_BACKEND_NAME_VK = 2
};
...
enum BRX_COLOR_ATTACHMENT_IMAGE_FORMAT
{
    ...
    BRX_COLOR_ATTACHMENT_FORMAT_R32G32_UINT = 6,
    BRX_COLOR_ATTACHMENT_FORMAT_R32G32B32A32_UINT = 7
};
...
enum BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION
{
    BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION_UNKNOWN = 0,
    BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION_GREATER = 1,
    BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION_LESS = 2,
    BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION_ALWAYS = 3
};

enum BRX_GRAPHICS_PIPELINE_BLEND_OPERATION
{
    BRX_GRAPHICS_PIPELINE_BLEND_OPERATION_UNKNOWN = 0,
    // The Over Operation: https://developer.nvidia.com/content/transparency-or-translucency-rendering
    BRX_GRAPHICS_PIPELINE_BLEND_OPERATION_OVER = 1
};
...
#define BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED 0XFFFFFFFFU
...
public:
    ...
    virtual brx_descriptor_set *create_descriptor_set(brx_descriptor_set_layout const *descriptor_set_layout, uint32_t unbounded_descriptor_count) = 0;
    ...
    virtual brx_graphics_pipeline *create_graphics_pipeline(brx_render_pass const *render_pass, brx_pipeline_layout const *pipeline_layout, size_t vertex_shader_module_code_size, void const *vertex_shader_module_code, size_t fragment_shader_module_code_size, void const *fragment_shader_module_code, bool enable_back_face_cull, bool front_ccw, bool enable_depth, BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION depth_compare_operation, bool enable_blend, BRX_GRAPHICS_PIPELINE_BLEND_OPERATION blend_operation) const = 0;
