...
public:
	...
	virtual void build_bottom_level_acceleration_structure_pass_store(uint32_t vertex_position_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *vertex_position_buffers, uint32_t index_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *index_buffers) = 0;
