...
{
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_R8G8B8A8_UNORM = 1,
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_R8G8B8A8_SRGB = 2,
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_BC7_UNORM_BLOCK = 3,
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_BC7_SRGB_BLOCK = 4,
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_UNORM_BLOCK = 5,
    BRX_SAMPLED_ASSET_IMAGE_FORMAT_ASTC_4x4_SRGB_BLOCK = 6
};

struct BRX_SAMPLED_ASSET_IMAGE_IMPORT_SUBRESOURCE_MEMCPY_DEST
{
...
static inline uint32_t brx_get_format_aspect_count(BRX_SAMPLED_ASSET_IMAGE_FORMAT format)
{
    switch (format)
    {
...
static inline uint32_t brx_get_format_block_size(BRX_SAMPLED_ASSET_IMAGE_FORMAT format)
{
    // TODO:
    switch (format)
    {
...
static inline uint32_t brx_get_format_block_width(BRX_SAMPLED_ASSET_IMAGE_FORMAT format)
{
    // TODO:
    switch (format)
    {
...
static inline uint32_t brx_get_format_block_height(BRX_SAMPLED_ASSET_IMAGE_FORMAT format)
{
    // TODO:
    switch (format)
    {
...
static inline constexpr uint32_t brx_sampled_asset_image_import_calculate_subresource_index(uint32_t mip_level, uint32_t array_layer, uint32_t aspect_index, uint32_t mip_levels, uint32_t array_layers)
{
...
static inline uint32_t brx_sampled_asset_image_import_calculate_subresource_memcpy_dests(BRX_SAMPLED_ASSET_IMAGE_FORMAT format, uint32_t width, uint32_t height, uint32_t depth, uint32_t mip_levels, uint32_t array_layers, size_t staging_upload_buffer_base_offset, uint32_t staging_upload_buffer_offset_alignment, uint32_t staging_upload_buffer_row_pitch_alignment, uint32_t subresource_count, BRX_SAMPLED_ASSET_IMAGE_IMPORT_SUBRESOURCE_MEMCPY_DEST *subresource_memcpy_dests)
{
    ...
    for (uint32_t aspect_index = 0U; aspect_index < aspect_count; ++aspect_index)
    {
        for (uint32_t array_layer = 0U; array_layer < array_layers; ++array_layer)
        {
            ...
            for (uint32_t mipLevel = 0U; mipLevel < mip_levels; ++mipLevel)
            {
                ...
                uint32_t const subresource_index = brx_sampled_asset_image_import_calculate_subresource_index(mipLevel, array_layer, aspect_index, mip_levels, array_layers);
