...
brx_d3d12_storage_intermediate_buffer::brx_d3d12_storage_intermediate_buffer() : m_resource(NULL), m_allocation(NULL)
{
}

void brx_d3d12_storage_intermediate_buffer::init(D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *storage_buffer_memory_pool, uint32_t wrapped_size)
{
...
void brx_d3d12_storage_intermediate_buffer::uninit()
{
    assert(NULL != this->m_resource);
    this->m_resource->Release();
    this->m_resource = NULL;
...
brx_d3d12_storage_intermediate_buffer::~brx_d3d12_storage_intermediate_buffer()
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
}

D3D12_SHADER_RESOURCE_VIEW_DESC const *brx_d3d12_storage_intermediate_buffer::get_shader_resource_view_desc() const
{
    return &this->m_shader_resource_view_desc;
}

D3D12_UNORDERED_ACCESS_VIEW_DESC const *brx_d3d12_storage_intermediate_buffer::get_unordered_access_view_desc() const
{
    return &this->m_unordered_access_view_desc;
}

ID3D12Resource *brx_d3d12_storage_intermediate_buffer::get_resource() const
{
    return this->m_resource;
}

brx_read_only_storage_buffer const *brx_d3d12_storage_intermediate_buffer::get_read_only_storage_buffer() const
{
    return static_cast<brx_d3d12_read_only_storage_buffer const *>(this);
}

brx_storage_buffer const *brx_d3d12_storage_intermediate_buffer::get_storage_buffer() const
{
    return static_cast<brx_d3d12_storage_buffer const *>(this);
}

brx_acceleration_structure_build_input_read_only_buffer const *brx_d3d12_storage_intermediate_buffer::get_acceleration_structure_build_input_read_only_buffer() const
{
    return static_cast<brx_acceleration_structure_build_input_read_only_buffer const *>(this);
}

brx_d3d12_storage_asset_buffer::brx_d3d12_storage_asset_buffer() : m_resource(NULL), m_allocation(NULL)
{
}

void brx_d3d12_storage_asset_buffer::init(bool uma, D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *storage_asset_buffer_memory_pool, uint32_t wrapped_size)
{
    uint32_t const num_elements = ((wrapped_size - 1U) / sizeof(uint32_t)) + 1U;
    uint32_t const size_elements = sizeof(uint32_t) * num_elements;
...
void brx_d3d12_storage_asset_buffer::uninit()
{
    assert(NULL != this->m_resource);
    this->m_resource->Release();
    this->m_resource = NULL;
...
brx_d3d12_storage_asset_buffer::~brx_d3d12_storage_asset_buffer()
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
}

ID3D12Resource *brx_d3d12_storage_asset_buffer::get_resource() const
{
    return this->m_resource;
}

D3D12_SHADER_RESOURCE_VIEW_DESC const *brx_d3d12_storage_asset_buffer::get_shader_resource_view_desc() const
{
    return &this->m_shader_resource_view_desc;
}

brx_read_only_storage_buffer const *brx_d3d12_storage_asset_buffer::get_read_only_storage_buffer() const
{
    return static_cast<brx_d3d12_read_only_storage_buffer const *>(this);
}

brx_acceleration_structure_build_input_read_only_buffer const *brx_d3d12_storage_asset_buffer::get_acceleration_structure_build_input_read_only_buffer() const
{
    return static_cast<brx_acceleration_structure_build_input_read_only_buffer const *>(this);
}
...
brx_d3d12_intermediate_bottom_level_acceleration_structure::brx_d3d12_intermediate_bottom_level_acceleration_structure() : m_resource(NULL), m_allocation(NULL)
{
}

void brx_d3d12_intermediate_bottom_level_acceleration_structure::init(D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *intermediate_bottom_level_acceleration_structure_memory_pool, uint32_t size)
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
...
void brx_d3d12_intermediate_bottom_level_acceleration_structure::uninit()
{
    assert(NULL != this->m_resource);
    this->m_resource->Release();
    this->m_resource = NULL;
...
brx_d3d12_intermediate_bottom_level_acceleration_structure::~brx_d3d12_intermediate_bottom_level_acceleration_structure()
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
}

ID3D12Resource *brx_d3d12_intermediate_bottom_level_acceleration_structure::get_resource() const
{
    return this->m_resource;
}

void brx_d3d12_intermediate_bottom_level_acceleration_structure::set_bottom_level_acceleration_structure_geometries(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries)
{
...
mcrt_vector<BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY> const &brx_d3d12_intermediate_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure_geometries() const
{
    return this->m_bottom_level_acceleration_structure_geometries;
}

brx_bottom_level_acceleration_structure const *brx_d3d12_intermediate_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure() const
{
    return static_cast<brx_d3d12_bottom_level_acceleration_structure const *>(this);
}

brx_d3d12_non_compacted_bottom_level_acceleration_structure::brx_d3d12_non_compacted_bottom_level_acceleration_structure() : m_resource(NULL), m_allocation(NULL)
{
}

void brx_d3d12_non_compacted_bottom_level_acceleration_structure::init(D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *non_compacted_bottom_level_acceleration_structure_memory_pool, uint32_t size)
{
    D3D12MA::ALLOCATION_DESC const allocation_desc = {
        D3D12MA::ALLOCATION_FLAG_NONE,
        D3D12_HEAP_TYPE_CUSTOM,
...
void brx_d3d12_non_compacted_bottom_level_acceleration_structure::uninit()
{
    assert(NULL != this->m_resource);
    this->m_resource->Release();
    this->m_resource = NULL;
...
brx_d3d12_non_compacted_bottom_level_acceleration_structure::~brx_d3d12_non_compacted_bottom_level_acceleration_structure()
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
}

ID3D12Resource *brx_d3d12_non_compacted_bottom_level_acceleration_structure::get_resource() const
{
    return this->m_resource;
}
...
brx_d3d12_compacted_bottom_level_acceleration_structure::brx_d3d12_compacted_bottom_level_acceleration_structure() : m_resource(NULL), m_allocation(NULL)
{
}

void brx_d3d12_compacted_bottom_level_acceleration_structure::init(D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *compacted_bottom_level_acceleration_structure_memory_pool, uint32_t size)
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
...
void brx_d3d12_compacted_bottom_level_acceleration_structure::uninit()
{
    assert(NULL != this->m_resource);
    this->m_resource->Release();
    this->m_resource = NULL;
...
brx_d3d12_compacted_bottom_level_acceleration_structure::~brx_d3d12_compacted_bottom_level_acceleration_structure()
{
    assert(NULL == this->m_resource);
    assert(NULL == this->m_allocation);
}

ID3D12Resource *brx_d3d12_compacted_bottom_level_acceleration_structure::get_resource() const
{
    return this->m_resource;
}

brx_bottom_level_acceleration_structure const *brx_d3d12_compacted_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure() const
{
    return static_cast<brx_d3d12_bottom_level_acceleration_structure const *>(this);
}
...
void brx_d3d12_top_level_acceleration_structure_instance_upload_buffer::write_instance(uint32_t instance_index, BRX_TOP_LEVEL_ACCELERATION_STRUCTURE_INSTANCE const *wrapped_bottom_top_acceleration_structure_instance)
{
    ...
    brx_d3d12_bottom_level_acceleration_structure const *const unwrapped_compacted_bottom_level_acceleration_structure = static_cast<brx_d3d12_bottom_level_acceleration_structure const *>(wrapped_bottom_top_acceleration_structure_instance->bottom_level_acceleration_structure);
