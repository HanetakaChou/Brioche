	...
	for (uint32_t set_index = 0U; set_index < descriptor_set_layout_count; ++set_index)
	{
		...
		for (uint32_t binding_index = 0U; binding_index < binding_count; ++binding_index)
		{
			...
			case BRX_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
			{
				...
				if (BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != descriptor_layouts[binding_index].root_descriptor_table_num_descriptors)
				{
			...
			case BRX_DESCRIPTOR_TYPE_STORAGE_BUFFER:
			{
				...
				assert(BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != descriptor_layouts[binding_index].root_descriptor_table_num_descriptors);
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].NumDescriptors = descriptor_layouts[binding_index].root_descriptor_table_num_descriptors;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].BaseShaderRegister = descriptor_layouts[binding_index].root_parameter_shader_register;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].RegisterSpace = set_index;
				root_descriptor_table_ranges[new_root_descriptor_table_range_index].OffsetInDescriptorsFromTableStart = 0U;
...
void brx_d3d12_descriptor_set::init(brx_d3d12_descriptor_allocator *descriptor_allocator, brx_descriptor_set_layout const *wrapped_descriptor_set_layout, uint32_t unbounded_descriptor_count)
{
	...
	for (uint32_t descriptor_layout_index = 0U; descriptor_layout_index < descriptor_layout_count; ++descriptor_layout_index)
	{
		...
		case BRX_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
		{
			new_descriptor.root_parameter_type = unwrapped_descriptor_layout.root_parameter_type;
			new_descriptor.root_parameter_shader_register = unwrapped_descriptor_layout.root_parameter_shader_register;
			if (BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != unwrapped_descriptor_layout.root_descriptor_table_num_descriptors)
			{
			...
			else
			{
				...
				new_descriptor.root_descriptor_table.num_descriptors = unbounded_descriptor_count;
			}
			new_descriptor.root_descriptor_table.base_descriptor_heap_index = descriptor_allocator->alloc_cbv_srv_uav_descriptor(new_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		case BRX_DESCRIPTOR_TYPE_STORAGE_BUFFER:
		{
			new_descriptor.root_parameter_type = unwrapped_descriptor_layout.root_parameter_type;
			new_descriptor.root_parameter_shader_register = unwrapped_descriptor_layout.root_parameter_shader_register;
			assert(BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != unwrapped_descriptor_layout.root_descriptor_table_num_descriptors);
			new_descriptor.root_descriptor_table.num_descriptors = unwrapped_descriptor_layout.root_descriptor_table_num_descriptors;
			new_descriptor.root_descriptor_table.base_descriptor_heap_index = descriptor_allocator->alloc_cbv_srv_uav_descriptor(new_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		...
		case BRX_DESCRIPTOR_TYPE_SAMPLER:
		{
			...
			assert(BRX_DESCRIPTOR_SET_LAYOUT_BINDING_DESCRIPTOR_COUNT_UNBOUNDED != unwrapped_descriptor_layout.root_descriptor_table_num_descriptors);
			new_descriptor.root_descriptor_table.num_descriptors = unwrapped_descriptor_layout.root_descriptor_table_num_descriptors;
			new_descriptor.root_descriptor_table.base_descriptor_heap_index = descriptor_allocator->alloc_sampler_descriptor(new_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		case BRX_DESCRIPTOR_TYPE_STORAGE_IMAGE:
		{
...
void brx_d3d12_descriptor_set::uninit(brx_d3d12_descriptor_allocator *descriptor_allocator)
{
	for (brx_d3d12_descriptor const &delete_descriptor : this->m_descriptors)
	{
		...
		case BRX_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
		{
			descriptor_allocator->free_cbv_srv_uav_descriptor(delete_descriptor.root_descriptor_table.base_descriptor_heap_index, delete_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		case BRX_DESCRIPTOR_TYPE_STORAGE_BUFFER:
		{
		...
		case BRX_DESCRIPTOR_TYPE_SAMPLER:
		{
			descriptor_allocator->free_sampler_descriptor(delete_descriptor.root_descriptor_table.base_descriptor_heap_index, delete_descriptor.root_descriptor_table.num_descriptors);
		}
		break;
		case BRX_DESCRIPTOR_TYPE_STORAGE_IMAGE:
		{
...
void brx_d3d12_descriptor_set::write_descriptor(ID3D12Device *device, brx_d3d12_descriptor_allocator const *descriptor_allocator, uint32_t dst_binding, BRX_DESCRIPTOR_TYPE wrapped_descriptor_type, uint32_t dst_descriptor_start_index, uint32_t src_descriptor_count, brx_uniform_upload_buffer const *const *src_dynamic_uniform_buffers, uint32_t const *src_dynamic_uniform_buffer_ranges, brx_read_only_storage_buffer const *const *src_read_only_storage_buffers, brx_storage_buffer const *const *src_storage_buffers, brx_sampled_image const *const *src_sampled_images, brx_storage_image const *const *src_storage_images, brx_sampler const *const *src_samplers, brx_top_level_acceleration_structure const *const *src_top_level_acceleration_structures)
{
	...
	case BRX_DESCRIPTOR_TYPE_READ_ONLY_STORAGE_BUFFER:
	{
		...
		for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
		{
			...
			assert((dst_descriptor_start_index + descriptor_index) < destination_descriptor.root_descriptor_table.num_descriptors);

			ID3D12Resource *const resource = static_cast<brx_d3d12_read_only_storage_buffer const *>(src_read_only_storage_buffers[descriptor_index])->get_resource();
			D3D12_SHADER_RESOURCE_VIEW_DESC const *const shader_resource_view_desc = static_cast<brx_d3d12_read_only_storage_buffer const *>(src_read_only_storage_buffers[descriptor_index])->get_shader_resource_view_desc();

			D3D12_CPU_DESCRIPTOR_HANDLE const shader_visible_shader_resource_view_descriptor = descriptor_allocator->get_shader_visible_cbv_srv_uav_cpu_descriptor_handle(destination_descriptor.root_descriptor_table.base_descriptor_heap_index + dst_descriptor_start_index + descriptor_index);
			D3D12_CPU_DESCRIPTOR_HANDLE const non_shader_visible_shader_resource_view_descriptor = descriptor_allocator->get_non_shader_visible_cbv_srv_uav_cpu_descriptor_handle(destination_descriptor.root_descriptor_table.base_descriptor_heap_index + dst_descriptor_start_index + descriptor_index);
	...
	case BRX_DESCRIPTOR_TYPE_SAMPLER:
	{
		...
		for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
		{
			...
			D3D12_CPU_DESCRIPTOR_HANDLE const shader_visible_sampler_descriptor = descriptor_allocator->get_shader_visible_sampler_cpu_descriptor_handle(destination_descriptor.root_descriptor_table.base_descriptor_heap_index + dst_descriptor_start_index + descriptor_index);
			D3D12_CPU_DESCRIPTOR_HANDLE const non_shader_visible_sampler_descriptor = descriptor_allocator->get_non_shader_visible_sampler_cpu_descriptor_handle(destination_descriptor.root_descriptor_table.base_descriptor_heap_index + dst_descriptor_start_index + descriptor_index);
