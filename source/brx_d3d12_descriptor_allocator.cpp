...
uint32_t brx_d3d12_descriptor_allocator::alloc_cbv_srv_uav_descriptor(uint32_t num_descriptors)
{
#if defined(ENABLE_STAGING_HEAP_VALIDATION) && ENABLE_STAGING_HEAP_VALIDATION
...
void brx_d3d12_descriptor_allocator::free_cbv_srv_uav_descriptor(uint32_t base_descriptor_heap_index, uint32_t num_descriptors)
{
#if defined(ENABLE_STAGING_HEAP_VALIDATION) && ENABLE_STAGING_HEAP_VALIDATION
	assert(this->m_statistic_get_shader_visible_cbv_srv_uav_cpu_descriptor_handle == this->m_statistic_get_non_shader_visible_cbv_srv_uav_cpu_descriptor_handle);
#endif
...
uint32_t brx_d3d12_descriptor_allocator::alloc_sampler_descriptor(uint32_t num_descriptors)
{
#if defined(ENABLE_STAGING_HEAP_VALIDATION) && ENABLE_STAGING_HEAP_VALIDATION
...
void brx_d3d12_descriptor_allocator::free_sampler_descriptor(uint32_t base_descriptor_heap_index, uint32_t num_descriptors)
{
#if defined(ENABLE_STAGING_HEAP_VALIDATION) && ENABLE_STAGING_HEAP_VALIDATION
	assert(this->m_statistic_get_shader_visible_sampler_cpu_descriptor_handle == this->m_statistic_get_non_shader_visible_sampler_cpu_descriptor_handle);
#endif
