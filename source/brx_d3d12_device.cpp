...
void brx_d3d12_device::get_staging_non_compacted_bottom_level_acceleration_structure_size(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, uint32_t *staging_non_compacted_bottom_level_acceleration_structure_size, uint32_t *build_scratch_size) const
{
	...
	mcrt_vector<D3D12_RAYTRACING_GEOMETRY_DESC> ray_tracing_geometry_descs;
...
{
	void *new_unwrapped_staging_non_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_staging_non_compacted_bottom_level_acceleration_structure), alignof(brx_d3d12_staging_non_compacted_bottom_level_acceleration_structure));
...
{
	void *new_unwrapped_asset_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_asset_compacted_bottom_level_acceleration_structure), alignof(brx_d3d12_asset_compacted_bottom_level_acceleration_structure));
