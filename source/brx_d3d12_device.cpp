...
extern void brx_destroy_d3d12_device(brx_device *wrapped_device)
{
...
{
    void *new_unwrapped_graphics_queue_base = mcrt_malloc(sizeof(brx_d3d12_graphics_queue), alignof(brx_d3d12_graphics_queue));
...
{
    void *new_unwrapped_upload_queue_base = mcrt_malloc(sizeof(brx_d3d12_upload_queue), alignof(brx_d3d12_upload_queue));
...
{
    void *new_unwrapped_graphics_command_buffer_base = mcrt_malloc(sizeof(brx_d3d12_graphics_command_buffer), alignof(brx_d3d12_graphics_command_buffer));
...
{
    void *new_unwrapped_upload_command_buffer_base = mcrt_malloc(sizeof(brx_d3d12_upload_command_buffer), alignof(brx_d3d12_upload_command_buffer));
...
brx_fence *brx_d3d12_device::create_fence(bool signaled) const
{
    ...
    void *new_brx_fence_base = mcrt_malloc(sizeof(brx_d3d12_fence), alignof(brx_d3d12_fence));
...
{
    void *new_unwrapped_descriptor_set_layout_base = mcrt_malloc(sizeof(brx_d3d12_descriptor_set_layout), alignof(brx_d3d12_descriptor_set_layout));
...
{
    void *new_unwrapped_pipeline_layout_base = mcrt_malloc(sizeof(brx_d3d12_pipeline_layout), alignof(brx_d3d12_pipeline_layout));
...
brx_descriptor_set *brx_d3d12_device::create_descriptor_set(brx_descriptor_set_layout const *descriptor_set_layout, uint32_t unbounded_descriptor_count)
{
    void *new_unwrapped_descriptor_set_base = mcrt_malloc(sizeof(brx_d3d12_descriptor_set), alignof(brx_d3d12_descriptor_set));
...
{
    mcrt_vector<BRX_COLOR_ATTACHMENT_IMAGE_FORMAT> new_color_attachment_formats;
    ...
    mcrt_vector<BRX_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT> new_depth_stencil_attachment_format;
    ...
    void *new_brx_render_pass_base = mcrt_malloc(sizeof(brx_d3d12_render_pass), alignof(brx_d3d12_render_pass));
...
{
    void *new_unwrapped_graphics_pipeline_base = mcrt_malloc(sizeof(brx_d3d12_graphics_pipeline), alignof(brx_d3d12_graphics_pipeline));
    ...
    new_unwrapped_graphics_pipeline->init(this->m_device, render_pass, pipeline_layout, vertex_shader_module_code_size, vertex_shader_module_code, fragment_shader_module_code_size, fragment_shader_module_code, enable_back_face_cull, front_ccw, enable_depth, depth_compare_operation, enable_blend, blend_operation);
...
{
    void *new_unwrapped_compute_pipeline_base = mcrt_malloc(sizeof(brx_d3d12_compute_pipeline), alignof(brx_d3d12_compute_pipeline));
...
brx_frame_buffer *brx_d3d12_device::create_frame_buffer(brx_render_pass const *brx_render_pass, uint32_t width, uint32_t height, uint32_t color_attachment_count, brx_color_attachment_image const *const *color_attachments, brx_depth_stencil_attachment_image const *depth_stencil_attachment) const
{
    ...
    void *new_brx_frame_buffer_base = mcrt_malloc(sizeof(brx_d3d12_frame_buffer), alignof(brx_d3d12_frame_buffer));
...
uint32_t brx_d3d12_device::get_uniform_upload_buffer_offset_alignment() const
{
...
{
    void *new_unwrapped_uniform_upload_buffer_base = mcrt_malloc(sizeof(brx_d3d12_uniform_upload_buffer), alignof(brx_d3d12_uniform_upload_buffer));
...
{
    void *new_unwrapped_staging_upload_buffer_base = mcrt_malloc(sizeof(brx_d3d12_staging_upload_buffer), alignof(brx_d3d12_staging_upload_buffer));
...
brx_storage_intermediate_buffer *brx_d3d12_device::create_storage_intermediate_buffer(uint32_t size) const
{
    void *new_unwrapped_storage_intermediate_buffer_base = mcrt_malloc(sizeof(brx_d3d12_storage_intermediate_buffer), alignof(brx_d3d12_storage_intermediate_buffer));
    assert(NULL != new_unwrapped_storage_intermediate_buffer_base);

    brx_d3d12_storage_intermediate_buffer *new_unwrapped_storage_intermediate_buffer = new (new_unwrapped_storage_intermediate_buffer_base) brx_d3d12_storage_intermediate_buffer{};
...
void brx_d3d12_device::destroy_storage_intermediate_buffer(brx_storage_intermediate_buffer *wrapped_storage_intermediate_buffer) const
{
    assert(NULL != wrapped_storage_intermediate_buffer);
    brx_d3d12_storage_intermediate_buffer *delete_unwrapped_storage_intermediate_buffer = static_cast<brx_d3d12_storage_intermediate_buffer *>(wrapped_storage_intermediate_buffer);

    delete_unwrapped_storage_intermediate_buffer->uninit();

    delete_unwrapped_storage_intermediate_buffer->~brx_d3d12_storage_intermediate_buffer();
    mcrt_free(delete_unwrapped_storage_intermediate_buffer);
}

brx_storage_asset_buffer *brx_d3d12_device::create_storage_asset_buffer(uint32_t size) const
{
    void *new_unwrapped_storage_asset_buffer_base = mcrt_malloc(sizeof(brx_d3d12_storage_asset_buffer), alignof(brx_d3d12_storage_asset_buffer));
    assert(NULL != new_unwrapped_storage_asset_buffer_base);

    brx_d3d12_storage_asset_buffer *new_unwrapped_storage_asset_buffer = new (new_unwrapped_storage_asset_buffer_base) brx_d3d12_storage_asset_buffer{};
...
void brx_d3d12_device::destroy_storage_asset_buffer(brx_storage_asset_buffer *wrapped_asset_storage_buffer) const
{
    assert(NULL != wrapped_asset_storage_buffer);
    brx_d3d12_storage_asset_buffer *delete_unwrapped_asset_storage_buffer = static_cast<brx_d3d12_storage_asset_buffer *>(wrapped_asset_storage_buffer);

    delete_unwrapped_asset_storage_buffer->uninit();

    delete_unwrapped_asset_storage_buffer->~brx_d3d12_storage_asset_buffer();
...
{
    void *new_unwrapped_color_attachment_image_base = mcrt_malloc(sizeof(brx_d3d12_color_attachment_intermediate_image), alignof(brx_d3d12_color_attachment_intermediate_image));
    assert(NULL != new_unwrapped_color_attachment_image_base);

    brx_d3d12_color_attachment_intermediate_image *new_unwrapped_color_attachment_image = new (new_unwrapped_color_attachment_image_base) brx_d3d12_color_attachment_intermediate_image{};
...
void brx_d3d12_device::destroy_color_attachment_image(brx_color_attachment_image *wrapped_color_attachment_image) const
{
    ...
    brx_d3d12_color_attachment_intermediate_image *delete_unwrapped_color_attachment_image = static_cast<brx_d3d12_color_attachment_intermediate_image *>(wrapped_color_attachment_image);

    delete_unwrapped_color_attachment_image->uninit();

    delete_unwrapped_color_attachment_image->~brx_d3d12_color_attachment_intermediate_image();
...
{
    void *new_unwrapped_depth_stencil_attachment_image_base = mcrt_malloc(sizeof(brx_d3d12_depth_stencil_attachment_intermediate_image), alignof(brx_d3d12_depth_stencil_attachment_intermediate_image));
    assert(NULL != new_unwrapped_depth_stencil_attachment_image_base);

    brx_d3d12_depth_stencil_attachment_intermediate_image *new_unwrapped_depth_stencil_attachment_image = new (new_unwrapped_depth_stencil_attachment_image_base) brx_d3d12_depth_stencil_attachment_intermediate_image{};
...
void brx_d3d12_device::destroy_depth_stencil_attachment_image(brx_depth_stencil_attachment_image *wrapped_depth_stencil_attachment_image) const
{
    ...
    brx_d3d12_depth_stencil_attachment_intermediate_image *delete_unwrapped_depth_stencil_attachment_image = static_cast<brx_d3d12_depth_stencil_attachment_intermediate_image *>(wrapped_depth_stencil_attachment_image);

    delete_unwrapped_depth_stencil_attachment_image->uninit();

    delete_unwrapped_depth_stencil_attachment_image->~brx_d3d12_depth_stencil_attachment_intermediate_image();
...
brx_storage_image *brx_d3d12_device::create_storage_image(BRX_STORAGE_IMAGE_FORMAT wrapped_storage_image_format, uint32_t width, uint32_t height, bool allow_sampled_image) const
{
    ...
    void *new_unwrapped_storage_image_base = mcrt_malloc(sizeof(brx_d3d12_storage_intermediate_image), alignof(brx_d3d12_storage_intermediate_image));
    assert(NULL != new_unwrapped_storage_image_base);

    brx_d3d12_storage_intermediate_image *new_unwrapped_storage_image = new (new_unwrapped_storage_image_base) brx_d3d12_storage_intermediate_image{};
...
void brx_d3d12_device::destroy_storage_image(brx_storage_image *wrapped_storage_image) const
{
    ...
    brx_d3d12_storage_intermediate_image *delete_unwrapped_storage_image = static_cast<brx_d3d12_storage_intermediate_image *>(wrapped_storage_image);

    delete_unwrapped_storage_image->uninit();

    delete_unwrapped_storage_image->~brx_d3d12_storage_intermediate_image();
    mcrt_free(delete_unwrapped_storage_image);
}

bool brx_d3d12_device::is_sampled_asset_image_compression_bc_supported() const
{
    return true;
}

bool brx_d3d12_device::is_sampled_asset_image_compression_astc_supported() const
{
    return false;
}

brx_sampled_asset_image *brx_d3d12_device::create_sampled_asset_image(BRX_SAMPLED_ASSET_IMAGE_FORMAT wrapped_sampled_asset_image_format, uint32_t width, uint32_t height, uint32_t mip_levels) const
{
    ...
    void *new_unwrapped_sampled_asset_image_base = mcrt_malloc(sizeof(brx_d3d12_sampled_asset_image), alignof(brx_d3d12_sampled_asset_image));
    assert(NULL != new_unwrapped_sampled_asset_image_base);

    brx_d3d12_sampled_asset_image *new_unwrapped_sampled_asset_image = new (new_unwrapped_sampled_asset_image_base) brx_d3d12_sampled_asset_image{};
...
void brx_d3d12_device::destroy_sampled_asset_image(brx_sampled_asset_image *wrapped_sampled_asset_image) const
{
    assert(NULL != wrapped_sampled_asset_image);
    brx_d3d12_sampled_asset_image *delete_unwrapped_sampled_asset_image = static_cast<brx_d3d12_sampled_asset_image *>(wrapped_sampled_asset_image);

    delete_unwrapped_sampled_asset_image->uninit();

    delete_unwrapped_sampled_asset_image->~brx_d3d12_sampled_asset_image();
...
brx_sampler *brx_d3d12_device::create_sampler(BRX_SAMPLER_FILTER wrapped_filter) const
{
    ...
    void *new_brx_sampler_base = mcrt_malloc(sizeof(brx_d3d12_sampler), alignof(brx_d3d12_sampler));
...
brx_surface *brx_d3d12_device::create_surface(void *wsi_window) const
{
    static_assert(sizeof(brx_surface *) == sizeof(HWND), "");
    return static_cast<brx_surface *>(wsi_window);
}
...
brx_swap_chain *brx_d3d12_device::create_swap_chain(brx_surface *surface) const
{
    ...
    mcrt_vector<brx_d3d12_swap_chain_image> new_swap_chain_images;
    {
    ...
    void *new_brx_swap_chain_base = mcrt_malloc(sizeof(brx_d3d12_swap_chain), alignof(brx_d3d12_swap_chain));
...
void brx_d3d12_device::destroy_swap_chain(brx_swap_chain *brx_swap_chain) const
{
    ...
    mcrt_vector<brx_d3d12_swap_chain_image> stealed_images;
...
{
    void *new_unwrapped_scratch_buffer_base = mcrt_malloc(sizeof(brx_d3d12_scratch_buffer), alignof(brx_d3d12_scratch_buffer));
...
void brx_d3d12_device::get_intermediate_bottom_level_acceleration_structure_size(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, uint32_t *intermediate_bottom_level_acceleration_structure_size, uint32_t *build_scratch_size, uint32_t *update_scratch_size) const
{
    ...
    for (uint32_t bottom_level_acceleration_structure_geometry_index = 0U; bottom_level_acceleration_structure_geometry_index < bottom_level_acceleration_structure_geometry_count; ++bottom_level_acceleration_structure_geometry_index)
    {
        ...
        D3D12_GPU_VIRTUAL_ADDRESS const vertex_position_buffer_device_memory_range_base = static_cast<brx_d3d12_acceleration_structure_build_input_read_only_buffer const *>(wrapped_bottom_level_acceleration_structure_geometry.vertex_position_buffer)->get_resource()->GetGPUVirtualAddress();
...
brx_intermediate_bottom_level_acceleration_structure *brx_d3d12_device::create_intermediate_bottom_level_acceleration_structure(uint32_t size) const
{
    void *new_unwrapped_intermediate_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_intermediate_bottom_level_acceleration_structure), alignof(brx_d3d12_intermediate_bottom_level_acceleration_structure));
    assert(NULL != new_unwrapped_intermediate_bottom_level_acceleration_structure_base);

    brx_d3d12_intermediate_bottom_level_acceleration_structure *new_unwrapped_intermediate_bottom_level_acceleration_structure = new (new_unwrapped_intermediate_bottom_level_acceleration_structure_base) brx_d3d12_intermediate_bottom_level_acceleration_structure{};
...
void brx_d3d12_device::destroy_intermediate_bottom_level_acceleration_structure(brx_intermediate_bottom_level_acceleration_structure *wrapped_intermediate_bottom_level_acceleration_structure) const
{
    assert(NULL != wrapped_intermediate_bottom_level_acceleration_structure);
    brx_d3d12_intermediate_bottom_level_acceleration_structure *delete_unwrapped_intermediate_bottom_level_acceleration_structure = static_cast<brx_d3d12_intermediate_bottom_level_acceleration_structure *>(wrapped_intermediate_bottom_level_acceleration_structure);

    delete_unwrapped_intermediate_bottom_level_acceleration_structure->uninit();

    delete_unwrapped_intermediate_bottom_level_acceleration_structure->~brx_d3d12_intermediate_bottom_level_acceleration_structure();
    mcrt_free(delete_unwrapped_intermediate_bottom_level_acceleration_structure);
}

void brx_d3d12_device::get_non_compacted_bottom_level_acceleration_structure_size(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, uint32_t *non_compacted_bottom_level_acceleration_structure_size, uint32_t *build_scratch_size) const
{
    assert(NULL != wrapped_bottom_level_acceleration_structure_geometries);
...
brx_non_compacted_bottom_level_acceleration_structure *brx_d3d12_device::create_non_compacted_bottom_level_acceleration_structure(uint32_t size) const
{
    void *new_unwrapped_non_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_non_compacted_bottom_level_acceleration_structure), alignof(brx_d3d12_non_compacted_bottom_level_acceleration_structure));
    assert(NULL != new_unwrapped_non_compacted_bottom_level_acceleration_structure_base);

    brx_d3d12_non_compacted_bottom_level_acceleration_structure *new_unwrapped_non_compacted_bottom_level_acceleration_structure = new (new_unwrapped_non_compacted_bottom_level_acceleration_structure_base) brx_d3d12_non_compacted_bottom_level_acceleration_structure{};
...
void brx_d3d12_device::destroy_non_compacted_bottom_level_acceleration_structure(brx_non_compacted_bottom_level_acceleration_structure *wrapped_non_compacted_bottom_level_acceleration_structure) const
{
    assert(NULL != wrapped_non_compacted_bottom_level_acceleration_structure);
    brx_d3d12_non_compacted_bottom_level_acceleration_structure *delete_unwrapped_non_compacted_bottom_level_acceleration_structure = static_cast<brx_d3d12_non_compacted_bottom_level_acceleration_structure *>(wrapped_non_compacted_bottom_level_acceleration_structure);

    delete_unwrapped_non_compacted_bottom_level_acceleration_structure->uninit();

    delete_unwrapped_non_compacted_bottom_level_acceleration_structure->~brx_d3d12_non_compacted_bottom_level_acceleration_structure();
...
{
    void *new_unwrapped_compacted_bottom_level_acceleration_structure_size_query_pool_base = mcrt_malloc(sizeof(brx_d3d12_compacted_bottom_level_acceleration_structure_size_query_pool), alignof(brx_d3d12_compacted_bottom_level_acceleration_structure_size_query_pool));
...
brx_compacted_bottom_level_acceleration_structure *brx_d3d12_device::create_compacted_bottom_level_acceleration_structure(uint32_t size) const
{
    void *new_unwrapped_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_compacted_bottom_level_acceleration_structure), alignof(brx_d3d12_compacted_bottom_level_acceleration_structure));
    assert(NULL != new_unwrapped_compacted_bottom_level_acceleration_structure_base);

    brx_d3d12_compacted_bottom_level_acceleration_structure *new_unwrapped_compacted_bottom_level_acceleration_structure = new (new_unwrapped_compacted_bottom_level_acceleration_structure_base) brx_d3d12_compacted_bottom_level_acceleration_structure{};
...
void brx_d3d12_device::destroy_compacted_bottom_level_acceleration_structure(brx_compacted_bottom_level_acceleration_structure *wrapped_compacted_bottom_level_acceleration_structure) const
{
    assert(NULL != wrapped_compacted_bottom_level_acceleration_structure);
    brx_d3d12_compacted_bottom_level_acceleration_structure *delete_unwrapped_compacted_bottom_level_acceleration_structure = static_cast<brx_d3d12_compacted_bottom_level_acceleration_structure *>(wrapped_compacted_bottom_level_acceleration_structure);

    delete_unwrapped_compacted_bottom_level_acceleration_structure->uninit();

    delete_unwrapped_compacted_bottom_level_acceleration_structure->~brx_d3d12_compacted_bottom_level_acceleration_structure();
...
{
    void *new_unwrapped_top_level_acceleration_structure_instance_upload_buffer_base = mcrt_malloc(sizeof(brx_d3d12_top_level_acceleration_structure_instance_upload_buffer), alignof(brx_d3d12_top_level_acceleration_structure_instance_upload_buffer));
...
{
    void *new_unwrapped_top_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_d3d12_top_level_acceleration_structure), alignof(brx_d3d12_top_level_acceleration_structure));
