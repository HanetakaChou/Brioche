...
class brx_d3d12_storage_intermediate_buffer : public brx_storage_intermediate_buffer, brx_d3d12_read_only_storage_buffer, brx_d3d12_storage_buffer, brx_d3d12_acceleration_structure_build_input_read_only_buffer
{
...
class brx_d3d12_storage_asset_buffer : public brx_storage_asset_buffer, brx_d3d12_read_only_storage_buffer, brx_d3d12_acceleration_structure_build_input_read_only_buffer
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_SHADER_RESOURCE_VIEW_DESC m_shader_resource_view_desc;
...
class brx_d3d12_color_attachment_intermediate_image : public brx_d3d12_color_attachment_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_depth_stencil_attachment_intermediate_image : public brx_d3d12_depth_stencil_attachment_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_storage_intermediate_image : public brx_d3d12_storage_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_UNORDERED_ACCESS_VIEW_DESC m_unordered_access_view_desc;
...
class brx_d3d12_sampled_asset_image : public brx_sampled_asset_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_SHADER_RESOURCE_VIEW_DESC m_shader_resource_view_desc;
...
class brx_d3d12_intermediate_bottom_level_acceleration_structure : public brx_intermediate_bottom_level_acceleration_structure, brx_d3d12_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_non_compacted_bottom_level_acceleration_structure : public brx_non_compacted_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_compacted_bottom_level_acceleration_structure : public brx_compacted_bottom_level_acceleration_structure, brx_d3d12_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
