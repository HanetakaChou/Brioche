...
class brx_d3d12_device final : public brx_device
{
...
private:
    ...
    brx_descriptor_set *create_descriptor_set(brx_descriptor_set_layout const *descriptor_set_layout, uint32_t unbounded_descriptor_count) override;
    ...
    brx_graphics_pipeline *create_graphics_pipeline(brx_render_pass const *render_pass, brx_pipeline_layout const *pipeline_layout, size_t vertex_shader_module_code_size, void const *vertex_shader_module_code, size_t fragment_shader_module_code_size, void const *fragment_shader_module_code, bool enable_back_face_cull, bool front_ccw, bool enable_depth, BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION depth_compare_operation, bool enable_blend, BRX_GRAPHICS_PIPELINE_BLEND_OPERATION blend_operation) const override;
    ...
    void get_non_compacted_bottom_level_acceleration_structure_size(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *bottom_level_acceleration_structure_geometries, uint32_t *non_compacted_bottom_level_acceleration_structure_size, uint32_t *build_scratch_size) const override;
...
class brx_d3d12_graphics_queue final : public brx_graphics_queue
{
    ID3D12CommandQueue *m_graphics_queue;
    bool m_uma;
    bool m_support_ray_tracing;
...
class brx_d3d12_upload_queue final : public brx_upload_queue
{
    ID3D12CommandQueue *m_upload_queue;
    bool m_uma;
    bool m_support_ray_tracing;
...
class brx_d3d12_graphics_command_buffer final : public brx_graphics_command_buffer
{
    bool m_uma;
    bool m_support_ray_tracing;
...
class brx_d3d12_upload_command_buffer final : public brx_upload_command_buffer
{
    bool m_uma;
    bool m_support_ray_tracing;
...
class brx_d3d12_descriptor_set_layout final : public brx_descriptor_set_layout
{
    mcrt_vector<brx_d3d12_descriptor_layout> m_descriptor_layouts;
...
class brx_d3d12_pipeline_layout final : public brx_pipeline_layout
{
...
class brx_d3d12_descriptor_set final : public brx_descriptor_set
{
    mcrt_vector<brx_d3d12_descriptor> m_descriptors;

public:
    brx_d3d12_descriptor_set();
    void init(brx_d3d12_descriptor_allocator *descriptor_allocator, brx_descriptor_set_layout const *descriptor_set_layout, uint32_t unbounded_descriptor_count);
    void uninit(brx_d3d12_descriptor_allocator *descriptor_allocator);
    ~brx_d3d12_descriptor_set();
    void write_descriptor(ID3D12Device *device, brx_d3d12_descriptor_allocator const *descriptor_allocator, uint32_t dst_binding, BRX_DESCRIPTOR_TYPE descriptor_type, uint32_t dst_descriptor_start_index, uint32_t src_descriptor_count, brx_uniform_upload_buffer const *const *src_dynamic_uniform_buffers, uint32_t const *src_dynamic_uniform_buffer_ranges, brx_read_only_storage_buffer const *const *src_read_only_storage_buffers, brx_storage_buffer const *const *src_storage_buffers, brx_sampled_image const *const *src_sampled_images, brx_storage_image const *const *src_storage_images, brx_sampler const *const *src_samplers, brx_top_level_acceleration_structure const *const *src_top_level_acceleration_structures);
    uint32_t get_descriptor_count() const;
    brx_d3d12_descriptor const *get_descriptors() const;
};

class brx_d3d12_render_pass final : public brx_render_pass
{
    mcrt_vector<BRX_COLOR_ATTACHMENT_IMAGE_FORMAT> m_color_attachment_formats;
    mcrt_vector<uint32_t> m_color_attachment_clear_indices;
    mcrt_vector<uint32_t> m_color_attachment_flush_for_sampled_image_indices;
    mcrt_vector<uint32_t> m_color_attachment_flush_for_present_indices;
    mcrt_vector<BRX_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT> m_depth_stencil_attachment_format;
    bool m_depth_stencil_attachment_clear;
    bool m_depth_stencil_attachment_flush_for_sampled_image;

public:
    brx_d3d12_render_pass(
        mcrt_vector<BRX_COLOR_ATTACHMENT_IMAGE_FORMAT> &&color_attachment_formats,
        mcrt_vector<uint32_t> &&color_attachment_clear_indices,
        mcrt_vector<uint32_t> &&color_attachment_flush_for_sampled_image_indices,
        mcrt_vector<uint32_t> &&color_attachment_flush_for_present_indices,
        mcrt_vector<BRX_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT> &&depth_stencil_attachment_format,
...
class brx_d3d12_graphics_pipeline final : public brx_graphics_pipeline
{
...
public:
    ...
    void init(ID3D12Device *device, brx_render_pass const *render_pass, brx_pipeline_layout const *pipeline_layout, size_t vertex_shader_module_code_size, void const *vertex_shader_module_code, size_t fragment_shader_module_code_size, void const *fragment_shader_module_code, bool enable_back_face_cull, bool front_ccw, bool enable_depth, BRX_GRAPHICS_PIPELINE_DEPTH_COMPARE_OPERATION depth_compare_operation, bool enable_blend, BRX_GRAPHICS_PIPELINE_BLEND_OPERATION blend_operation);
    void uninit();
    ~brx_d3d12_graphics_pipeline();
...
class brx_d3d12_compute_pipeline final : public brx_compute_pipeline
{
    ID3D12PipelineState *m_pipeline_state;
...
class brx_d3d12_frame_buffer final : public brx_frame_buffer
{
    mcrt_vector<ID3D12Resource *> m_render_target_resources;
    mcrt_vector<D3D12_CPU_DESCRIPTOR_HANDLE> m_render_target_view_descriptors;
    ID3D12Resource *m_depth_stencil_resource;
    mcrt_vector<D3D12_CPU_DESCRIPTOR_HANDLE> m_depth_stencil_view_descriptor;

public:
    brx_d3d12_frame_buffer(mcrt_vector<ID3D12Resource *> &&render_target_resources, mcrt_vector<D3D12_CPU_DESCRIPTOR_HANDLE> &&render_target_view_descriptors, ID3D12Resource *depth_stencil_resource, mcrt_vector<D3D12_CPU_DESCRIPTOR_HANDLE> &&depth_stencil_view_descriptor);
...
class brx_d3d12_uniform_upload_buffer final : public brx_uniform_upload_buffer
{
...
class brx_d3d12_staging_upload_buffer final : public brx_staging_upload_buffer
{
    ID3D12Resource *m_resource = NULL;
    D3D12MA::Allocation *m_allocation;
    void *m_host_memory_range_base = NULL;
...
class brx_d3d12_read_only_storage_buffer : public brx_read_only_storage_buffer
{
public:
...
class brx_d3d12_acceleration_structure_build_input_read_only_buffer : public brx_acceleration_structure_build_input_read_only_buffer
{
public:
    virtual ID3D12Resource *get_resource() const = 0;
};

class brx_d3d12_storage_intermediate_buffer final : public brx_storage_intermediate_buffer, brx_d3d12_read_only_storage_buffer, brx_d3d12_storage_buffer, brx_d3d12_acceleration_structure_build_input_read_only_buffer
{
...
public:
    brx_d3d12_storage_intermediate_buffer();
...
class brx_d3d12_storage_asset_buffer final : public brx_storage_asset_buffer, brx_d3d12_read_only_storage_buffer, brx_d3d12_acceleration_structure_build_input_read_only_buffer
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_SHADER_RESOURCE_VIEW_DESC m_shader_resource_view_desc;
...
public:
    brx_d3d12_storage_asset_buffer();
...
class brx_d3d12_color_attachment_intermediate_image final : public brx_d3d12_color_attachment_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
public:
    brx_d3d12_color_attachment_intermediate_image();
    void init(ID3D12Device *device, D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *color_attachment_intermediate_image_memory_pool, BRX_COLOR_ATTACHMENT_IMAGE_FORMAT color_attachment_image_format, uint32_t width, uint32_t height, bool allow_sampled_image);
    void uninit();
    ~brx_d3d12_color_attachment_intermediate_image();
...
class brx_d3d12_depth_stencil_attachment_intermediate_image final : public brx_d3d12_depth_stencil_attachment_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
public:
    brx_d3d12_depth_stencil_attachment_intermediate_image();
    void init(ID3D12Device *device, D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *depth_stencil_attachment_intermediate_image_memory_pool, BRX_DEPTH_STENCIL_ATTACHMENT_IMAGE_FORMAT wrapped_depth_stencil_attachment_image_format, uint32_t width, uint32_t height, bool allow_sampled_image);
    void uninit();
    ~brx_d3d12_depth_stencil_attachment_intermediate_image();
...
class brx_d3d12_storage_intermediate_image final : public brx_d3d12_storage_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_UNORDERED_ACCESS_VIEW_DESC m_unordered_access_view_desc;
...
public:
    brx_d3d12_storage_intermediate_image();
    void init(D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *storage_intermediate_image_memory_pool, DXGI_FORMAT storage_image_format, uint32_t width, uint32_t height, bool allow_sampled_image);
    void uninit();
    ~brx_d3d12_storage_intermediate_image();
...
class brx_d3d12_sampled_asset_image final : public brx_sampled_asset_image, brx_d3d12_sampled_image
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_SHADER_RESOURCE_VIEW_DESC m_shader_resource_view_desc;
...
public:
    brx_d3d12_sampled_asset_image();
    void init(bool uma, D3D12MA::Allocator *memory_allocator, D3D12MA::Pool *sampled_asset_image_memory_pool, DXGI_FORMAT sampled_asset_image_format, uint32_t width, uint32_t height, uint32_t mip_levels);
    void uninit();
    ~brx_d3d12_sampled_asset_image();
...
class brx_d3d12_swap_chain_image final : public brx_d3d12_color_attachment_image
{
    ID3D12Resource *m_resource;
    D3D12_CPU_DESCRIPTOR_HANDLE m_render_target_view_descriptor;
...
class brx_d3d12_swap_chain final : public brx_swap_chain
{
    ...
    mcrt_vector<brx_d3d12_swap_chain_image> m_images;

public:
    brx_d3d12_swap_chain(IDXGISwapChain3 *swap_chain, DXGI_FORMAT image_format, uint32_t image_width, uint32_t image_height, uint32_t image_count, ID3D12DescriptorHeap *rtv_descriptor_heap, mcrt_vector<brx_d3d12_swap_chain_image> &&m_images);
    ...
    void steal(IDXGISwapChain3 **out_swap_chain, ID3D12DescriptorHeap **out_rtv_descriptor_heap, mcrt_vector<brx_d3d12_swap_chain_image> &out_images);
    ~brx_d3d12_swap_chain();
};

class brx_d3d12_scratch_buffer final : public brx_scratch_buffer
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_bottom_level_acceleration_structure : public brx_bottom_level_acceleration_structure
{
public:
    virtual ID3D12Resource *get_resource() const = 0;
};

class brx_d3d12_intermediate_bottom_level_acceleration_structure final : public brx_intermediate_bottom_level_acceleration_structure, brx_d3d12_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
public:
    brx_d3d12_intermediate_bottom_level_acceleration_structure();
...
class brx_d3d12_non_compacted_bottom_level_acceleration_structure final : public brx_non_compacted_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;

public:
    brx_d3d12_non_compacted_bottom_level_acceleration_structure();
...
class brx_d3d12_compacted_bottom_level_acceleration_structure_size_query_pool final : public brx_compacted_bottom_level_acceleration_structure_size_query_pool
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_compacted_bottom_level_acceleration_structure final : public brx_compacted_bottom_level_acceleration_structure, brx_d3d12_bottom_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;

public:
    brx_d3d12_compacted_bottom_level_acceleration_structure();
...
class brx_d3d12_top_level_acceleration_structure_instance_upload_buffer final : public brx_top_level_acceleration_structure_instance_upload_buffer
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
...
class brx_d3d12_top_level_acceleration_structure final : public brx_top_level_acceleration_structure
{
    ID3D12Resource *m_resource;
    D3D12MA::Allocation *m_allocation;
    D3D12_SHADER_RESOURCE_VIEW_DESC m_shader_resource_view_desc;
