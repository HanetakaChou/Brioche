...
public:
	...
	void begin() override;
	void acquire(uint32_t storage_asset_buffer_count, brx_storage_asset_buffer const *const *storage_asset_buffers, uint32_t sampled_asset_image_count, brx_sampled_asset_image const *const *sampled_asset_images, uint32_t const *dst_mip_levels, uint32_t asset_compacted_bottom_level_acceleration_structure_count, brx_asset_compacted_bottom_level_acceleration_structure const *const *asset_compacted_bottom_level_acceleration_structures) override;
...
public:
	...
	void build_bottom_level_acceleration_structure_pass_load(uint32_t acceleration_structure_build_input_read_only_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *acceleration_structure_build_input_read_only_buffers) override;
	void build_bottom_level_acceleration_structure(brx_staging_non_compacted_bottom_level_acceleration_structure *staging_non_compacted_bottom_level_acceleration_structure, uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *bottom_level_acceleration_structure_geometries, brx_scratch_buffer *scratch_buffer, brx_compacted_bottom_level_acceleration_structure_size_query_pool *compacted_bottom_level_acceleration_structure_size_query_pool, uint32_t query_index) override;
	void build_bottom_level_acceleration_structure_pass_store(uint32_t acceleration_structure_build_input_read_only_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *acceleration_structure_build_input_read_only_buffers) override;
