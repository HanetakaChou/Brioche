...
brx_vk_storage_intermediate_buffer::brx_vk_storage_intermediate_buffer() : m_buffer(VK_NULL_HANDLE), m_allocation(VK_NULL_HANDLE), m_device_memory_range_base(0U), m_size(static_cast<VkDeviceSize>(-1))
{
}

void brx_vk_storage_intermediate_buffer::init(bool support_ray_tracing, VkDevice device, PFN_vkGetBufferDeviceAddressKHR pfn_get_buffer_device_address, VmaAllocator memory_allocator, VmaPool storage_intermediate_buffer_memory_pool, uint32_t size)
{
...
void brx_vk_storage_intermediate_buffer::uninit(VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_buffer);
    assert(VK_NULL_HANDLE != this->m_allocation);
...
brx_vk_storage_intermediate_buffer::~brx_vk_storage_intermediate_buffer()
{
    assert(VK_NULL_HANDLE == this->m_buffer);
    assert(VK_NULL_HANDLE == this->m_allocation);
}

VkBuffer brx_vk_storage_intermediate_buffer::get_buffer() const
{
    return this->m_buffer;
}

VkDeviceSize brx_vk_storage_intermediate_buffer::get_size() const
{
    return this->m_size;
}

VkDeviceAddress brx_vk_storage_intermediate_buffer::get_device_memory_range_base() const
{
    return this->m_device_memory_range_base;
}

brx_read_only_storage_buffer const *brx_vk_storage_intermediate_buffer::get_read_only_storage_buffer() const
{
    return static_cast<brx_vk_read_only_storage_buffer const *>(this);
}

brx_storage_buffer const *brx_vk_storage_intermediate_buffer::get_storage_buffer() const
{
    return static_cast<brx_vk_storage_buffer const *>(this);
}

brx_acceleration_structure_build_input_read_only_buffer const *brx_vk_storage_intermediate_buffer::get_acceleration_structure_build_input_read_only_buffer() const
{
    return static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(this);
}

brx_vk_storage_asset_buffer::brx_vk_storage_asset_buffer() : m_buffer(VK_NULL_HANDLE), m_allocation(VK_NULL_HANDLE), m_device_memory_range_base(0U), m_size(static_cast<VkDeviceSize>(-1))
{
}

void brx_vk_storage_asset_buffer::init(bool support_ray_tracing, VkDevice device, PFN_vkGetBufferDeviceAddressKHR pfn_get_buffer_device_address, VmaAllocator memory_allocator, VmaPool storage_asset_buffer_memory_pool, uint32_t size)
{
...
void brx_vk_storage_asset_buffer::uninit(VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_buffer);
    assert(VK_NULL_HANDLE != this->m_allocation);
...
brx_vk_storage_asset_buffer::~brx_vk_storage_asset_buffer()
{
    assert(VK_NULL_HANDLE == this->m_buffer);
    assert(VK_NULL_HANDLE == this->m_allocation);
}

VkBuffer brx_vk_storage_asset_buffer::get_buffer() const
{
    return this->m_buffer;
}

VkDeviceSize brx_vk_storage_asset_buffer::get_size() const
{
    return this->m_size;
}

VkDeviceAddress brx_vk_storage_asset_buffer::get_device_memory_range_base() const
{
    return this->m_device_memory_range_base;
}

brx_read_only_storage_buffer const *brx_vk_storage_asset_buffer::get_read_only_storage_buffer() const
{
    return static_cast<brx_vk_read_only_storage_buffer const *>(this);
}

brx_acceleration_structure_build_input_read_only_buffer const *brx_vk_storage_asset_buffer::get_acceleration_structure_build_input_read_only_buffer() const
{
    return static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(this);
}
...
void brx_vk_intermediate_bottom_level_acceleration_structure::uninit(VkDevice device, PFN_vkDestroyAccelerationStructureKHR pfn_destroy_acceleration_structure, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_acceleration_structure);
...
brx_vk_intermediate_bottom_level_acceleration_structure::~brx_vk_intermediate_bottom_level_acceleration_structure()
{
    assert(VK_NULL_HANDLE == this->m_buffer);
    assert(VK_NULL_HANDLE == this->m_allocation);
    assert(VK_NULL_HANDLE == this->m_acceleration_structure);
...
VkBuffer brx_vk_intermediate_bottom_level_acceleration_structure::get_buffer() const
{
    return this->m_buffer;
}

VkAccelerationStructureKHR brx_vk_intermediate_bottom_level_acceleration_structure::get_acceleration_structure() const
{
    return this->m_acceleration_structure;
}

void brx_vk_intermediate_bottom_level_acceleration_structure::set_bottom_level_acceleration_structure_geometries(uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries)
{
...
mcrt_vector<BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY> const &brx_vk_intermediate_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure_geometries() const
{
    return this->m_bottom_level_acceleration_structure_geometries;
}

VkDeviceAddress brx_vk_intermediate_bottom_level_acceleration_structure::get_device_memory_range_base() const
{
    return this->m_device_memory_range_base;
}

brx_bottom_level_acceleration_structure const *brx_vk_intermediate_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure() const
{
    return static_cast<brx_bottom_level_acceleration_structure const *>(this);
}

brx_vk_non_compacted_bottom_level_acceleration_structure::brx_vk_non_compacted_bottom_level_acceleration_structure() : m_buffer(VK_NULL_HANDLE), m_allocation(VK_NULL_HANDLE), m_acceleration_structure(VK_NULL_HANDLE)
{
}

void brx_vk_non_compacted_bottom_level_acceleration_structure::init(VkDevice device, PFN_vkCreateAccelerationStructureKHR pfn_create_acceleration_structure, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator, VmaPool non_compacted_bottom_level_acceleration_structure_memory_pool, uint32_t size)
{
    VkBufferCreateInfo const buffer_create_info = {
        VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO,
        NULL,
...
void brx_vk_non_compacted_bottom_level_acceleration_structure::uninit(VkDevice device, PFN_vkDestroyAccelerationStructureKHR pfn_destroy_acceleration_structure, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_acceleration_structure);
...
brx_vk_non_compacted_bottom_level_acceleration_structure::~brx_vk_non_compacted_bottom_level_acceleration_structure()
{
    assert(VK_NULL_HANDLE == this->m_acceleration_structure);
}

VkBuffer brx_vk_non_compacted_bottom_level_acceleration_structure::get_buffer() const
{
    return this->m_buffer;
}

VkAccelerationStructureKHR brx_vk_non_compacted_bottom_level_acceleration_structure::get_acceleration_structure() const
{
    return this->m_acceleration_structure;
}
...
void brx_vk_compacted_bottom_level_acceleration_structure_size_query_pool::init(VkDevice device, PFN_vkCreateQueryPool pfn_create_query_pool, VkAllocationCallbacks const *allocation_callbacks, uint32_t query_count)
{
...
void brx_vk_compacted_bottom_level_acceleration_structure_size_query_pool::uninit(VkDevice device, PFN_vkDestroyQueryPool pfn_destroy_query_pool, VkAllocationCallbacks const *allocation_callbacks)
{
    assert(VK_NULL_HANDLE != this->m_query_pool);
...
brx_vk_compacted_bottom_level_acceleration_structure::brx_vk_compacted_bottom_level_acceleration_structure() : m_buffer(VK_NULL_HANDLE), m_allocation(VK_NULL_HANDLE), m_acceleration_structure(VK_NULL_HANDLE), m_device_memory_range_base(0U)
{
}

void brx_vk_compacted_bottom_level_acceleration_structure::init(VkDevice device, PFN_vkCreateAccelerationStructureKHR pfn_create_acceleration_structure, PFN_vkGetAccelerationStructureDeviceAddressKHR pfn_get_acceleration_structure_device_address, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator, VmaPool compacted_bottom_level_acceleration_structure_memory_pool, uint32_t size)
{
    VkBufferCreateInfo const buffer_create_info = {
        VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO,
        NULL,
...
void brx_vk_compacted_bottom_level_acceleration_structure::uninit(VkDevice device, PFN_vkDestroyAccelerationStructureKHR pfn_destroy_acceleration_structure, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_acceleration_structure);
...
brx_vk_compacted_bottom_level_acceleration_structure::~brx_vk_compacted_bottom_level_acceleration_structure()
{
    assert(VK_NULL_HANDLE == this->m_buffer);
    assert(VK_NULL_HANDLE == this->m_allocation);
    assert(VK_NULL_HANDLE == this->m_acceleration_structure);
...
VkBuffer brx_vk_compacted_bottom_level_acceleration_structure::get_buffer() const
{
    return this->m_buffer;
}

VkAccelerationStructureKHR brx_vk_compacted_bottom_level_acceleration_structure::get_acceleration_structure() const
{
    return this->m_acceleration_structure;
}

VkDeviceAddress brx_vk_compacted_bottom_level_acceleration_structure::get_device_memory_range_base() const
{
    return this->m_device_memory_range_base;
}

brx_bottom_level_acceleration_structure const *brx_vk_compacted_bottom_level_acceleration_structure::get_bottom_level_acceleration_structure() const
{
    return static_cast<brx_bottom_level_acceleration_structure const *>(this);
}
...
void brx_vk_top_level_acceleration_structure_instance_upload_buffer::write_instance(uint32_t instance_index, BRX_TOP_LEVEL_ACCELERATION_STRUCTURE_INSTANCE const *wrapped_bottom_top_acceleration_structure_instance)
{
    ...
    brx_vk_bottom_level_acceleration_structure const *const unwrapped_compacted_bottom_level_acceleration_structure = static_cast<brx_vk_bottom_level_acceleration_structure const *>(wrapped_bottom_top_acceleration_structure_instance->bottom_level_acceleration_structure);
...
void brx_vk_top_level_acceleration_structure::uninit(VkDevice device, PFN_vkDestroyAccelerationStructureKHR pfn_destroy_acceleration_structure, VkAllocationCallbacks const *allocation_callbacks, VmaAllocator memory_allocator)
{
    assert(VK_NULL_HANDLE != this->m_acceleration_structure);
