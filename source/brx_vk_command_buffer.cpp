...
void brx_vk_graphics_command_buffer::acquire(uint32_t storage_asset_buffer_count, brx_storage_asset_buffer const *const *wrapped_storage_asset_buffers, uint32_t sampled_asset_image_count, brx_sampled_asset_image const *const *wrapped_sampled_asset_images, uint32_t const *dst_mip_levels, uint32_t compacted_bottom_level_acceleration_structure_count, brx_compacted_bottom_level_acceleration_structure const *const *wrapped_compacted_bottom_level_acceleration_structures)
{
    if (this->m_has_dedicated_upload_queue)
    {
        if (this->m_upload_queue_family_index != this->m_graphics_queue_family_index)
        {
            ...
            {
                VkBuffer const storage_asset_buffer = static_cast<brx_vk_storage_asset_buffer const *>(wrapped_storage_asset_buffers[storage_asset_buffer_index])->get_buffer();
            ...
            {
                VkBuffer const asset_acceleration_structure_buffer = static_cast<brx_vk_compacted_bottom_level_acceleration_structure const *>(wrapped_compacted_bottom_level_acceleration_structures[compacted_bottom_level_acceleration_structure_index])->get_buffer();
...
void brx_vk_graphics_command_buffer::set_scissor(int32_t offset_width, int32_t offset_height, uint32_t width, uint32_t height)
{
...
void brx_vk_graphics_command_buffer::draw(uint32_t vertex_count, uint32_t instance_count, uint32_t first_vertex, uint32_t first_instance)
{
...
void brx_vk_graphics_command_buffer::compute_pass_load(uint32_t storage_buffer_count, brx_storage_buffer const *const *wrapped_storage_buffers, BRX_COMPUTE_PASS_STORAGE_BUFFER_LOAD_OPERATION const *storage_buffer_load_operations, uint32_t storage_image_count, brx_storage_image const *const *wrapped_storage_images, BRX_COMPUTE_PASS_STORAGE_IMAGE_LOAD_OPERATION const *storage_image_load_operations)
{
    ...
    {
        VkBuffer const storage_buffer = static_cast<brx_vk_storage_buffer const *>(wrapped_storage_buffers[storage_buffer_index])->get_buffer();
    ...
    {
        VkImage const storage_image = static_cast<brx_vk_storage_image const *>(wrapped_storage_images[storage_image_index])->get_image();
    ...
    this->m_pfn_cmd_pipeline_barrier(this->m_command_buffer, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, 0U, 0U, NULL, static_cast<uint32_t>(buffer_load_barriers.size()), buffer_load_barriers.data(), static_cast<uint32_t>(image_load_barriers.size()), image_load_barriers.data());
}
...
void brx_vk_graphics_command_buffer::compute_pass_store(uint32_t storage_buffer_count, brx_storage_buffer const *const *wrapped_storage_buffers, BRX_COMPUTE_PASS_STORAGE_BUFFER_STORE_OPERATION const *storage_buffer_store_operations, uint32_t storage_image_count, brx_storage_image const *const *wrapped_storage_images, BRX_COMPUTE_PASS_STORAGE_IMAGE_STORE_OPERATION const *storage_image_store_operations)
{
    ...
    this->m_pfn_cmd_pipeline_barrier(this->m_command_buffer, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, graphics_queue_family_store_destination_stage, 0U, 0U, NULL, static_cast<uint32_t>(buffer_store_barriers.size()), buffer_store_barriers.data(), static_cast<uint32_t>(image_store_barriers.size()), image_store_barriers.data());
}

void brx_vk_graphics_command_buffer::build_intermediate_bottom_level_acceleration_structure(brx_intermediate_bottom_level_acceleration_structure *wrapped_intermediate_bottom_level_acceleration_structure, uint32_t bottom_level_acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, brx_scratch_buffer *wrapped_scratch_buffer)
{
    assert(NULL != wrapped_intermediate_bottom_level_acceleration_structure);
    VkAccelerationStructureKHR const destination_acceleration_structure = static_cast<brx_vk_intermediate_bottom_level_acceleration_structure *>(wrapped_intermediate_bottom_level_acceleration_structure)->get_acceleration_structure();
    ...
    for (uint32_t bottom_level_acceleration_structure_geometry_index = 0U; bottom_level_acceleration_structure_geometry_index < bottom_level_acceleration_structure_geometry_count; ++bottom_level_acceleration_structure_geometry_index)
    {
        ...
        brx_vk_acceleration_structure_build_input_read_only_buffer const *const unwrapped_vertex_position_buffer = static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(wrapped_bottom_level_acceleration_structure_geometry.vertex_position_buffer);

        brx_vk_acceleration_structure_build_input_read_only_buffer const *const unwrapped_index_buffer = (BRX_GRAPHICS_PIPELINE_INDEX_TYPE_NONE != wrapped_bottom_level_acceleration_structure_geometry.index_type) ? static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(wrapped_bottom_level_acceleration_structure_geometry.index_buffer) : NULL;
        ...
        VkDeviceAddress const index_buffer_device_memory_range_base = (BRX_GRAPHICS_PIPELINE_INDEX_TYPE_NONE != wrapped_bottom_level_acceleration_structure_geometry.index_type) ? unwrapped_index_buffer->get_device_memory_range_base() : 0U;
    ...
    static_cast<brx_vk_intermediate_bottom_level_acceleration_structure *>(wrapped_intermediate_bottom_level_acceleration_structure)->set_bottom_level_acceleration_structure_geometries(bottom_level_acceleration_structure_geometry_count, wrapped_bottom_level_acceleration_structure_geometries);
}

void brx_vk_graphics_command_buffer::build_intermediate_bottom_level_acceleration_structure_store(uint32_t intermediate_bottom_level_acceleration_structure_count, brx_intermediate_bottom_level_acceleration_structure const *const *wrapped_intermediate_bottom_level_acceleration_structures)
{
    ...
    {
        VkBuffer const unwrapped_acceleration_structure_buffer = static_cast<brx_vk_intermediate_bottom_level_acceleration_structure const *>(wrapped_intermediate_bottom_level_acceleration_structures[intermediate_bottom_level_acceleration_structure_index])->get_buffer();
...
void brx_vk_graphics_command_buffer::update_intermediate_bottom_level_acceleration_structure(brx_intermediate_bottom_level_acceleration_structure *wrapped_intermediate_bottom_level_acceleration_structure, brx_acceleration_structure_build_input_read_only_buffer const *const *wrapped_bottom_level_acceleration_structure_geometry_vertex_position_buffers, brx_scratch_buffer *wrapped_scratch_buffer)
{
    assert(NULL != wrapped_intermediate_bottom_level_acceleration_structure);
    VkAccelerationStructureKHR const destination_acceleration_structure = static_cast<brx_vk_intermediate_bottom_level_acceleration_structure *>(wrapped_intermediate_bottom_level_acceleration_structure)->get_acceleration_structure();

    mcrt_vector<BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY> const &wrapped_bottom_level_acceleration_structure_geometries = static_cast<brx_vk_intermediate_bottom_level_acceleration_structure *>(wrapped_intermediate_bottom_level_acceleration_structure)->get_bottom_level_acceleration_structure_geometries();
    ...
    for (uint32_t bottom_level_acceleration_structure_geometry_index = 0U; bottom_level_acceleration_structure_geometry_index < bottom_level_acceleration_structure_geometry_count; ++bottom_level_acceleration_structure_geometry_index)
    {
        ...
        brx_vk_acceleration_structure_build_input_read_only_buffer const *const unwrapped_vertex_position_buffer = static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(wrapped_bottom_level_acceleration_structure_geometry_vertex_position_buffers[bottom_level_acceleration_structure_geometry_index]);
...
void brx_vk_graphics_command_buffer::update_intermediate_bottom_level_acceleration_structure_store(uint32_t intermediate_bottom_level_acceleration_structure_count, brx_intermediate_bottom_level_acceleration_structure const *const *wrapped_intermediate_bottom_level_acceleration_structures)
{
    mcrt_vector<VkBufferMemoryBarrier> store_barriers(static_cast<size_t>(intermediate_bottom_level_acceleration_structure_count));
...
void brx_vk_graphics_command_buffer::build_top_level_acceleration_structure_store(brx_top_level_acceleration_structure *wrapped_top_level_acceleration_structure)
{
    assert(NULL != wrapped_top_level_acceleration_structure);
    VkBuffer const unwrapped_acceleration_structure_buffer = static_cast<brx_vk_top_level_acceleration_structure *>(wrapped_top_level_acceleration_structure)->get_buffer();
...
void brx_vk_graphics_command_buffer::update_top_level_acceleration_structure_store(brx_top_level_acceleration_structure *wrapped_top_level_acceleration_structure)
{
    assert(NULL != wrapped_top_level_acceleration_structure);
...
void brx_vk_upload_command_buffer::upload_from_staging_upload_buffer_to_storage_asset_buffer(brx_storage_asset_buffer *wrapped_storage_asset_buffer, uint64_t dst_offset, brx_staging_upload_buffer *wrapped_staging_upload_buffer, uint64_t src_offset, uint32_t src_size)
{
    assert(NULL != wrapped_storage_asset_buffer);
    VkBuffer const asset_buffer = static_cast<brx_vk_storage_asset_buffer *>(wrapped_storage_asset_buffer)->get_buffer();
...
void brx_vk_upload_command_buffer::upload_from_staging_upload_buffer_to_sampled_asset_image(brx_sampled_asset_image *wrapped_sampled_asset_image, BRX_SAMPLED_ASSET_IMAGE_FORMAT wrapped_sampled_asset_image_format, uint32_t sampled_asset_image_width, uint32_t sampled_asset_image_height, uint32_t dst_mip_level, brx_staging_upload_buffer *wrapped_staging_upload_buffer, uint64_t src_offset, uint32_t src_row_pitch, uint32_t src_row_count)
{
    assert(NULL != wrapped_sampled_asset_image);
    VkImage const sampled_asset_image = static_cast<brx_vk_sampled_asset_image *>(wrapped_sampled_asset_image)->get_image();

    assert(NULL != wrapped_staging_upload_buffer);
    VkBuffer const staging_upload_buffer = static_cast<brx_vk_staging_upload_buffer *>(wrapped_staging_upload_buffer)->get_buffer();

    uint32_t const block_size = brx_get_format_block_size(wrapped_sampled_asset_image_format);
...
void brx_vk_upload_command_buffer::build_non_compacted_bottom_level_acceleration_structure_pass_load(uint32_t acceleration_structure_build_input_read_only_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *wrapped_acceleration_structure_build_input_read_only_buffers)
{
    ...
    {
        brx_vk_acceleration_structure_build_input_read_only_buffer const *const unwrapped_acceleration_structure_build_input_read_only_buffer = static_cast<brx_vk_acceleration_structure_build_input_read_only_buffer const *>(wrapped_acceleration_structure_build_input_read_only_buffers[acceleration_structure_build_input_read_only_buffer_index]);
...
void brx_vk_upload_command_buffer::build_non_compacted_bottom_level_acceleration_structure_pass_store(uint32_t acceleration_structure_build_input_read_only_buffer_count, brx_acceleration_structure_build_input_read_only_buffer const *const *acceleration_structure_build_input_read_only_buffers)
{
...
void brx_vk_upload_command_buffer::compact_bottom_level_acceleration_structure(brx_compacted_bottom_level_acceleration_structure *wrapped_destination_compacted_bottom_level_acceleration_structure, brx_non_compacted_bottom_level_acceleration_structure *wrapped_source_non_compacted_bottom_level_acceleration_structure)
{
    ...
    VkAccelerationStructureKHR const source_acceleration_structure = static_cast<brx_vk_non_compacted_bottom_level_acceleration_structure *>(wrapped_source_non_compacted_bottom_level_acceleration_structure)->get_acceleration_structure();

    assert(NULL != wrapped_destination_compacted_bottom_level_acceleration_structure);
    VkAccelerationStructureKHR const destination_acceleration_structure = static_cast<brx_vk_compacted_bottom_level_acceleration_structure *>(wrapped_destination_compacted_bottom_level_acceleration_structure)->get_acceleration_structure();
