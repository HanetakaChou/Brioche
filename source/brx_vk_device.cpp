...
extern VkPipelineStageFlags const g_graphics_queue_family_all_supported_shader_read_stages = VK_PIPELINE_STAGE_VERTEX_SHADER_BIT | VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT;
...
static inline void __intermediate_pause();
...
#error Unknown Compiler
    ...
    assert(VK_NULL_HANDLE == this->m_top_level_acceleration_structure_memory_pool);
    {
        ...
        assert(VK_NULL_HANDLE == this->m_storage_intermediate_buffer_memory_pool);
        {
            ...
            storage_intermediate_buffer_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_storage_asset_buffer_memory_pool);
        {
            ...
            storage_asset_buffer_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_color_transient_attachment_image_memory_pool);
        {
            ...
            color_transient_attachment_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_color_attachment_sampled_image_memory_pool);
        {
            ...
            // The lower index indicates the more performance
            color_attachment_sampled_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_depth_transient_attachment_image_memory_pool);
        {
            ...
            // The lower index indicates the more performance
            depth_transient_attachment_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT);
        ...
        if (this->m_depth_attachment_image_format_support_sampled_image)
        {
            ...
            // The lower index indicates the more performance
            depth_attachment_sampled_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_depth_stencil_transient_attachment_image_memory_pool);
        {
            ...
            // The lower index indicates the more performance
            depth_stencil_transient_attachment_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, VK_MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT);
        ...
        if (this->m_depth_stencil_attachment_image_format_support_sampled_image)
        {
            ...
            // The lower index indicates the more performance
            depth_stencil_attachment_sampled_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
        ...
        assert(VK_NULL_HANDLE == this->m_sampled_asset_image_memory_pool);
        {
            ...
            sampled_asset_image_memory_index = __intermediate_find_lowest_memory_type_index(&physical_device_memory_properties, memory_requirements_size, memory_requirements_memory_type_bits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
...
void brx_vk_device::uninit()
{
    ...
    assert((!this->m_support_ray_tracing) || (VK_NULL_HANDLE != this->m_staging_non_compacted_bottom_level_acceleration_structure_memory_pool));
    assert((!this->m_support_ray_tracing) || (VK_NULL_HANDLE != this->m_asset_compacted_bottom_level_acceleration_structure_memory_pool));
...
brx_render_pass *brx_vk_device::create_render_pass(uint32_t color_attachment_count, BRX_RENDER_PASS_COLOR_ATTACHMENT const *color_attachments, BRX_RENDER_PASS_DEPTH_STENCIL_ATTACHMENT const *depth_stencil_attachment) const
{
    ...
    VkRenderPass new_render_pass = VK_NULL_HANDLE;
    {
        ...
        VkPipelineStageFlags const graphics_queue_family_store_destination_stage = (!this->m_support_ray_tracing) ? (g_graphics_queue_family_all_supported_shader_read_stages) : (g_graphics_queue_family_all_supported_shader_read_stages | VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR);
...
void brx_vk_device::get_staging_non_compacted_bottom_level_acceleration_structure_size(uint32_t acceleration_structure_geometry_count, BRX_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, uint32_t *staging_non_compacted_bottom_level_acceleration_structure_size, uint32_t *build_scratch_size) const
{
    ...
    mcrt_vector<VkAccelerationStructureGeometryKHR> acceleration_structure_geometries;
    mcrt_vector<uint32_t> max_primitive_counts;
...
{
    void *new_unwrapped_staging_non_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_vk_staging_non_compacted_bottom_level_acceleration_structure), alignof(brx_vk_staging_non_compacted_bottom_level_acceleration_structure));
...
void brx_vk_device::destroy_staging_non_compacted_bottom_level_acceleration_structure(brx_staging_non_compacted_bottom_level_acceleration_structure *wrapped_staging_non_compacted_bottom_level_acceleration_structure) const
{
    ...
    mcrt_free(delete_unwrapped_staging_non_compacted_bottom_level_acceleration_structure);
}
...
{
    void *new_unwrapped_asset_compacted_bottom_level_acceleration_structure_base = mcrt_malloc(sizeof(brx_vk_asset_compacted_bottom_level_acceleration_structure), alignof(brx_vk_asset_compacted_bottom_level_acceleration_structure));
...
void brx_vk_device::destroy_asset_compacted_bottom_level_acceleration_structure(brx_asset_compacted_bottom_level_acceleration_structure *wrapped_asset_compacted_bottom_level_acceleration_structure) const
{
    ...
    mcrt_free(delete_unwrapped_asset_compacted_bottom_level_acceleration_structure);
}
