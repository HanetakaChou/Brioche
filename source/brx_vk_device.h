...
extern VkPipelineStageFlags const g_graphics_queue_family_all_supported_shader_read_stages;
...
class brx_vk_staging_non_compacted_bottom_level_acceleration_structure final : public brx_staging_non_compacted_bottom_level_acceleration_structure
{
    VkBuffer m_buffer;
    VmaAllocation m_allocation;
...
class brx_vk_asset_compacted_bottom_level_acceleration_structure final : public brx_asset_compacted_bottom_level_acceleration_structure
{
    VkBuffer m_buffer;
    VmaAllocation m_allocation;
    VkAccelerationStructureKHR m_acceleration_structure;
