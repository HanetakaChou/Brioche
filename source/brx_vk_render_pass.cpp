...
brx_vk_render_pass::brx_vk_render_pass(VkRenderPass render_pass, uint32_t color_attachment_count) : m_render_pass(render_pass), m_color_attachment_count(color_attachment_count)
{
}
...
uint32_t brx_vk_render_pass::get_color_attachment_count() const
{
