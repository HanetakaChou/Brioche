...
brx_vk_surface::brx_vk_surface() : m_surface(VK_NULL_HANDLE)
{
}

void brx_vk_surface::init(
    VkInstance instance,
    ...
    void *wsi_window)
{
...
#elif defined(VK_USE_PLATFORM_XCB_KHR)
    {
        ...
        brx_xcb_window_T *const brx_xcb_window = static_cast<brx_xcb_window_T *>(wsi_window);

        VkXcbSurfaceCreateInfoKHR const xcb_surface_create_info = {
            VK_STRUCTURE_TYPE_XCB_SURFACE_CREATE_INFO_KHR,
            NULL,
            0U,
            brx_xcb_window->m_connection,
            brx_xcb_window->m_window};
...
void brx_vk_surface::uninit(VkInstance instance, PFN_vkDestroySurfaceKHR pfn_destroy_surface, VkAllocationCallbacks const *allocation_callbacks)
{
...
brx_vk_swap_chain_image_view::brx_vk_swap_chain_image_view() : m_image_view(VK_NULL_HANDLE)
{
}

void brx_vk_swap_chain_image_view::init(VkDevice device, PFN_vkCreateImageView pfn_create_image_view, VkAllocationCallbacks const *allocation_callbacks, VkImage image, VkFormat image_format)
{
...
void brx_vk_swap_chain_image_view::uninit(VkDevice device, PFN_vkDestroyImageView pfn_destroy_image_view, VkAllocationCallbacks const *allocation_callbacks)
{
...
void brx_vk_swap_chain::uninit(VkDevice device, PFN_vkDestroySwapchainKHR pfn_destroy_swapchain, PFN_vkDestroyImageView pfn_destroy_image_view, VkAllocationCallbacks const *allocation_callbacks)
{
